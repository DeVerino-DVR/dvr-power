...
Spell modules are separate resources that register with th_power. See the [th-power-spells](https://github.com/DeVerino-DVR/dvr-power-spells) repository for all available spells.
